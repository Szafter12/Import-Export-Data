...
<body>
    <form enctype="multipart/form-data" id="form" class="container mx-auto mt-5 d-flex flex-column align-items-center gap-3">
        <h1>Export Excel File Data to Database</h1>
        <div class="form-group w-100 d-flex flex-column align-items-center gap-3">
            <label for="sheet" class="h4">Choose excel file</label>
            <input type="file" name="sheet" id="sheet" class="form-control">
        </div>
        <div class="form-group w-100 d-flex flex-column align-items-center gap-3">
            <label for="tableName" class="h4">Insert database table name</label>
            <input type="text" name="tableName" id="tableName" placeholder="table name" class="form-control w-100">
        </div>
        <div class="form-group w-100 d-flex flex-column align-items-center gap-3">
            <label for="columnCount" class="h4">Enter number of columns (exclude id, created_at etc columns)</label>
